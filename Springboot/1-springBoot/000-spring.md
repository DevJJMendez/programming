Spring y Spring Boot son dos proyectos relacionados del ecosistema Spring, pero tienen objetivos y funcionalidades diferentes.

## Spring Framework
Spring es un marco de trabajo (framework) para el desarrollo de aplicaciones Java. Proporciona una infraestructura completa para desarrollar aplicaciones empresariales robustas y de alto rendimiento.
